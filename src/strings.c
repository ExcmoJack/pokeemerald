...
const u8 gText_Cancel[] = _("Terminado");
...
const u8 gText_GoBackPrevMenu[] = _("Hay que colocar 10 adornos.\nNo te escaquees.");
...
const u8 gText_PutOutSelectedDecorItem[] = _("Añadir decoración al árbol.");
const u8 gText_StoreChosenDecorInPC[] = _("Guardar adornos en la caja.");
...
const u8 gText_Doll[] = _("{SIZE 8}Adornos árbol");
...
const u8 gText_CantBePlacedHere[] = _("Aquí no se puede.");
const u8 gText_CancelDecorating[] = _("¿Dejar de decorar?");
const u8 gText_InUseAlready[] = _("Ya lo has puesto, tolai.");
const u8 gText_NoMoreDecorations[] = _("Tranqui, colega, ya hay suficiente.\nCon poner {STR_VAR_1} adornos sobra.");
const u8 gText_NoMoreDecorations2[] = _("Tranqui, colega, ya hay suficiente.\nCon poner {STR_VAR_1} adornos sobra.");
...
const u8 gText_NoDecorationHere[] = _("Aquí no hay nada.");
const u8 gText_ReturnDecorationToPC[] = _("¿Quitar este adorno?");
const u8 gText_DecorationReturnedToPC[] = _("Se ha guardado este adorno en la caja.");
const u8 gText_NoDecorationsInUse[] = _("No hay nada en el árbol aún.{PAUSE_UNTIL_PRESS}");
